...
public class TexturedPolyBlockItem extends BlockItem implements PolymerItem {
    ...
    public TexturedPolyBlockItem(Block block, net.minecraft.item.Item.Settings settings, String modelId) {
        super(block, settings);
        polymerModel = PolymerResourcePackUtils.requestModel(Items.FLINT, Identifier.of(ColoredLanterns.MOD_ID, modelId ));
    }
