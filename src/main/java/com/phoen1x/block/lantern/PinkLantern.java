...
public class PinkLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    private PinkLantern.Model model;
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new PinkLantern.Model(initialBlockState, world, pos);
        return model;
    }
