...
import com.phoen1x.entity.LightGrayLanternBlockEntity;
...
public class LightGrayLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public static final MapCodec<LightGrayLantern> CODEC = createCodec(LightGrayLantern::new);
    private LightGrayLantern.Model model;
    ...
    public LightGrayLantern(Settings settings) {
        super(settings
                .nonOpaque()
                .luminance(state -> 15)
        );
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new LightGrayLanternBlockEntity(pos, state);
    }
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new LightGrayLantern.Model(initialBlockState, world, pos);
        return model;
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack STANDING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_gray_lantern"));
        public static final ItemStack HANGING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_gray_hanging_lantern"));
        public static final ItemStack WALL_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_gray_wall_lantern"));
