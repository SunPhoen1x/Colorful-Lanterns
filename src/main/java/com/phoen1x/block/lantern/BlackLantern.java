...
import com.phoen1x.entity.BlackLanternBlockEntity;
...
public class BlackLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public static final MapCodec<BlackLantern> CODEC = createCodec(BlackLantern::new);
    private BlackLantern.Model model;
    ...
    public BlackLantern(Settings settings) {
        super(settings
                .nonOpaque()
                .luminance(state -> 15)
        );
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BlackLanternBlockEntity(pos, state);
    }
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new BlackLantern.Model(initialBlockState, world, pos);
        return model;
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack STANDING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/black_lantern"));
        public static final ItemStack HANGING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/black_hanging_lantern"));
        public static final ItemStack WALL_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/black_wall_lantern"));
