...
public class LightBlueLantern extends RedLantern {
    ...
    protected RedLantern.Model createModel(BlockState initialBlockState, ServerWorld world, BlockPos pos) {
        return new LightBlueLantern.Model(initialBlockState, world, pos);
    }

    public static final class Model extends RedLantern.Model {
        public static final ItemStack STANDING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_blue_lantern"));
        public static final ItemStack HANGING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_blue_hanging_lantern"));
        public static final ItemStack WALL_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/light_blue_wall_lantern"));
