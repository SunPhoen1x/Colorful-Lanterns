...
public class OrangeLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    private OrangeLantern.Model model;
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new OrangeLantern.Model(initialBlockState, world, pos);
        return model;
    }
