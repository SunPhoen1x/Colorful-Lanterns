...
public class LimeLantern extends RedLantern {
    ...
    public static final class Model extends RedLantern.Model {
        public static final ItemStack STANDING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_lantern"));
        public static final ItemStack HANGING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_hanging_lantern"));
        public static final ItemStack WALL_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_wall_lantern"));
