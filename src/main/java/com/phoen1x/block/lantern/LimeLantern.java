...
public class LimeLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public static final MapCodec<LimeLantern> CODEC = createCodec(LimeLantern::new);
    private LimeLantern.Model model;
    ...
    public LimeLantern(Settings settings) {
        super(settings
                .nonOpaque()
                .luminance(state -> 15)
        );
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new LimeLanternBlockEntity(pos, state);
    }
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new LimeLantern.Model(initialBlockState, world, pos);
        return model;
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack STANDING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_lantern"));
        public static final ItemStack HANGING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_hanging_lantern"));
        public static final ItemStack WALL_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/lime_wall_lantern"));
