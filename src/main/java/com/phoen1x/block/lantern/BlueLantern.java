...
import com.phoen1x.entity.BlueLanternBlockEntity;
...
public class BlueLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public static final MapCodec<BlueLantern> CODEC = createCodec(BlueLantern::new);
    private BlueLantern.Model model;
    ...
    public BlueLantern(Settings settings) {
        super(settings
                .nonOpaque()
                .luminance(state -> 15)
        );
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BlueLanternBlockEntity(pos, state);
    }
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new BlueLantern.Model(initialBlockState, world, pos);
        return model;
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack STANDING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/blue_lantern"));
        public static final ItemStack HANGING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/blue_hanging_lantern"));
        public static final ItemStack WALL_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/blue_wall_lantern"));
