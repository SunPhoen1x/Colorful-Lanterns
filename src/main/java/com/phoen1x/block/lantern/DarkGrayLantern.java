...
import com.phoen1x.entity.DarkGrayLanternBlockEntity;
...
public class DarkGrayLantern extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public static final MapCodec<DarkGrayLantern> CODEC = createCodec(DarkGrayLantern::new);
    private DarkGrayLantern.Model model;
    ...
    public DarkGrayLantern(Settings settings) {
        super(settings
                .nonOpaque()
                .luminance(state -> 15)
        );
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DarkGrayLanternBlockEntity(pos, state);
    }
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        model = new DarkGrayLantern.Model(initialBlockState, world, pos);
        return model;
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack STANDING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/dark_gray_lantern"));
        public static final ItemStack HANGING_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/dark_gray_hanging_lantern"));
        public static final ItemStack WALL_MODEL = BaseItemProvider.requestModel(Identifier.of(ColoredLanterns.MOD_ID, "block/dark_gray_wall_lantern"));
