...
public class ModBlocks {
    public static final Block RED_LANTERN = registerBlock("red_lantern", RedLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block YELLOW_LANTERN = registerBlock("yellow_lantern", YellowLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block GREEN_LANTERN = registerBlock("green_lantern", GreenLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block ORANGE_LANTERN = registerBlock("orange_lantern", OrangeLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block LIME_LANTERN = registerBlock("lime_lantern", LimeLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block CYAN_LANTERN = registerBlock("cyan_lantern", CyanLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block BLUE_LANTERN = registerBlock("blue_lantern", BlueLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block LIGHT_BLUE_LANTERN = registerBlock("light_blue_lantern", LightBlueLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block PURPLE_LANTERN = registerBlock("purple_lantern", PurpleLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block MAGENTA_LANTERN = registerBlock("magenta_lantern", MagentaLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block PINK_LANTERN = registerBlock("pink_lantern", PinkLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block BROWN_LANTERN = registerBlock("brown_lantern", BrownLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block BLACK_LANTERN = registerBlock("black_lantern", BlackLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block DARK_GRAY_LANTERN = registerBlock("dark_gray_lantern", DarkGrayLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block LIGHT_GRAY_LANTERN = registerBlock("light_gray_lantern", LightGrayLantern::new, Block.Settings.copy(Blocks.LANTERN));
    public static final Block WHITE_LANTERN = registerBlock("white_lantern", WhiteLantern::new, Block.Settings.copy(Blocks.LANTERN));
